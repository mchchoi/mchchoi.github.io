...
Vitalii Kapitan and Michael C.H. Choi. Adaptive Gradient Scaling: Integrating Adam and Landscape Modification for Protein Structure Prediction. **BMC Bioinformatics**, to appear. \[[<i class="ai ai-researchgate ai-lg"></i>ResearchGate](https://www.researchgate.net/publication/392472584_Adaptive_Gradient_Scaling_Integrating_Adam_and_Landscape_Modification_for_Protein_Structure_Prediction)\]
